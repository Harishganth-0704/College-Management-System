        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
              <label className="text-sm font-medium text-blue-600">Current CGPA</label>
              <p className="text-2xl font-bold text-gray-900 mt-1">{profileData.currentCGPA || "N/A"}</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              <label className="text-sm font-medium text-gray-600">Total Fee</label>
              <p className="text-2xl font-bold text-gray-900 mt-1">₹{profileData.feeStatus?.totalFee || 0}</p>
            </div>
            <div className="bg-green-50 p-4 rounded-lg border border-green-100">
              <label className="text-sm font-medium text-green-600">Fee Paid</label>
              <p className="text-2xl font-bold text-gray-900 mt-1">₹{profileData.feeStatus?.paidFee || 0}</p>
            </div>
            <div className="bg-red-50 p-4 rounded-lg border border-red-100">
              <label className="text-sm font-medium text-red-600">Fee Pending</label>
              <p className="text-2xl font-bold text-gray-900 mt-1">₹{profileData.feeStatus?.pendingFee || 0}</p>
            </div>
          </div>
        </div>
