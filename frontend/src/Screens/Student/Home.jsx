...
const MENU_ITEMS = [
  ...
  { id: "attendance", label: "Attendance", component: MyAttendance },
  { id: "notifications", label: "Notifications 🔔", component: () => <Notifications role="student" /> },
];
...
const Home = () => {
  ...
  const getMenuItemClass = (menuId) => {
    ...
    return `
      text-center px-4 py-2.5 cursor-pointer
