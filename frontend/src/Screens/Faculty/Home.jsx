...
const MENU_ITEMS = [
  ...
  { id: "notes", label: "My Notes", component: Notes },
  { id: "attendance", label: "Attendance", component: Attendance },
  { id: "notifications", label: "Notifications 🔔", component: () => <Notifications role="faculty" /> },
];
...
const Home = () => {
  ...
  const getMenuItemClass = (menuId) => {
    ...
    return `text-center px-4 py-2.5 cursor-pointer font-medium text-sm whitespace-nowrap rounded-md ${
      isSelected
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto">
        <ul className="flex flex-wrap justify-center items-center gap-3 w-full mx-auto my-8">
          {MENU_ITEMS.map((item) => (
            <li
              key={item.id}
